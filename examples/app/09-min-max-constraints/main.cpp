...
int main()
{
    try
    {
        ...
        vkapp::Core::Window window({.width = 500,
                                    .height = 300,
                                    .title = "Flex Example: 09-min-max-constraints",
                                    .resizable = true});
